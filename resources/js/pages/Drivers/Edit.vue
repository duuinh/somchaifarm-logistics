...
const form = useForm({
    ...
    id_card_number: props.driver.id_card_number || '',
});
            ...
            <Card class="max-w-2xl mx-auto">
                <CardHeader>
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <CardTitle>แก้ไขข้อมูลคนขับ</CardTitle>
                            <CardDescription>แก้ไขข้อมูล {{ driver.name }}</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
